...
import { baseURL, fetchproductcategorywise, fetchproducts } from '../../ApiManager/AxiosManage';
...
const CategoryWiseProducts = () => {
  ...
  const fetchdetails = async () => {
    try {
      setloading(true)
      const response = await fetchproductcategorywise(slug);
  ...
  return (
    <Layout title={"Category Wise Product"}>
      ...
      {/* UnAuthorized Model Design Here */}
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          <Box>
            <center>
              <img src="https://t3.ftcdn.net/jpg/01/01/89/46/360_F_101894688_RVSZUtDfPR6Cr5eBDQI7Qo5pZ01jmyK3.jpg" alt="Image" width={300} />
            </center>
          </Box>
          <Typography id="modal-modal-description" sx={{ mt: 2, fontFamily: "Times" }}>
            <center> <h3>You are Not Authorized Person</h3></center> <br /> Please Login First......... <Link to='/login'>Click Me</Link>
          </Typography>
        </Box>
      </Modal>
    </Layout>
